    ...
    return (
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                ...
                <div className='col-3'>
                    <img className="ms-auto mb-4" src="media/image/logoo.png" alt="error" style={{ width: "45%" }} />
            ...
            <div className='row text-muted' style={{ fontSize: "11px" }}>
                <p>TradeX Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through TradeX Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through Zerodha Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI Registration no.: INZ000038238 Registered Address: TradeX Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@zerodha.com, for DP related to dp@TradeX.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
