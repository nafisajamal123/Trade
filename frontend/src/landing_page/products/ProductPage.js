...
function ProductPage() {
    return (
        <>
            ...
            <p className='text-center text-muted fs-4 mt-5 '>Want to know more about our technology stack? Check out the <a href='' style={{textDecoration:"none"}}>TradeX.tech</a> blog.</p><br/>
            <h2 className='text-center mt-5 mb-4'>The TradeX Universe</h2>
