        ...
        <div className='conatiner mt-5'>
            <div className='row'>
                <div className='col-6 p-5'>
                    <h2 className='fs-2.5 mb-5'>Trust with confidence</h2>
                ...
                <div className='col-6 p-5'>
                    <img src="media/image/ecosystem.png" style={{width:"90%"}} alt="error"/>
                    <div className='container'>
                        <div className='row'>
                            <div className='col-6'>
                            <a href='' style={{textDecoration:"none"}}>Explore our products<i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                            </div>
                            <div className='col-6'>
